package by.it.group473601.zapotylok.lesson03;
...
public class Lesson3Test {
    ...
    */
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group473601/zapotylok/lesson03/dataHuffman.txt");
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        File f = new File(root + "by/it/group473601/zapotylok/lesson03/encodeHuffman.txt");
